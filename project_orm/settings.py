...
SECRET_KEY = 'rc$k08yz6%=60%pqfv*dxff)*opkgp$(+_m!r*u@f!wnla$wo9'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'movie_catalog_db', # nombre de la base de datos, se creará en el servidor de Postgres a continuación
